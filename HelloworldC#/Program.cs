...
namespace HelloworldC_
{
    ...
    {
        //NUMERO9
        enum cor { azul , verde , amarelo, vermelho}//um EXpasse o mouse em cima daa palavras e veja seuss
        enum opcoes { criar = 1, deletar, editar, listar, atualizar}//valores crescentes e alteravei
